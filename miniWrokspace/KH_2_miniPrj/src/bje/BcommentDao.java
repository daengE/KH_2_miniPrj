...
public class BcommentDao {
   ...
   public int write(BcommentVo vocom, Connection conn, int boardnum) throws Exception {
      ...
      try {
         ...
         //SQL 작성
         String sql = "INSERT INTO BCOMMENT VALUES(SEQ_BCOMMENT_COM_NO.NEXTVAL , ? , ? , ? , DEFAULT , DEFAULT , DEFAULT)";
   ...
   public List<BcommentVo> showList(Connection conn, int num) throws Exception {
      //CONN 준비
      
      //SQL 준비
      String sql = "SELECT COM_NO , COM_NICK , COM_CONTENTS , COM_ENROLL_DATE FROM BCOMMENT WHERE B_NO = ?";
